...
export function categorizeOpayTransaction(description) {
    if (!description)
        return "Other";
            ...
            for (const match of matches) {
                try {
                    ...
                    if (transaction && isValidOpayTransaction(transaction)) {
                        ...
                        const isDuplicate = result.transactions.some(existing => existing.date === transaction.date &&
...
function parseOpayTransaction(match) {
    try {
...
function determineOpayTransactionType(description, amount) {
...
function formatOpayDate(dateStr) {
    try {
...
function isValidOpayTransaction(transaction) {
...
//# sourceMappingURL=opayParser.js.map