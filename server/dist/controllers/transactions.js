...
function normalizeType(type, legacy_type) {
...
export async function createTransaction(req, res) {
    try {
        ...
        const { amount, description, category, type, date, time, channel, transaction_reference, counterparty, balance_after, legacy_type } = req.body || {};
...
export async function updateTransaction(req, res) {
    try {
        ...
        if (transaction_reference)
            item.transaction_reference = transaction_reference;
